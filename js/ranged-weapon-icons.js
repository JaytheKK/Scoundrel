...
const RANGED_WEAPON_DESCRIPTIONS = {
  en: {
    ...
    25: 'A dark bow studded with iron thorns along its limbs, as vicious to hold as it is to be shot by.',
  ...
  de: {
    ...
    25: 'Ein dunkler Bogen mit eisernen Dornen entlang der Wurfarme, so bösartig in der Hand wie unter seinem Schuss.',
